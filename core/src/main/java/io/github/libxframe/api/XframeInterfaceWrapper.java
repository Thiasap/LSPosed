...
/**
 * Wrap of {@link XframeInterface} used by the modules for the purpose of shielding framework implementation details.
 */
public class XframeInterfaceWrapper implements XframeInterface {

    private final XframeInterface mBase;

    XframeInterfaceWrapper(@NonNull XframeInterface base) {
        mBase = base;
    }
