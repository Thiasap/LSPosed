 ...
 */
public interface IXframeHookInitPackageResources extends IXframeMod {
    /**
    ...
    final class Wrapper extends XC_InitPackageResources {
        private final IXframeHookInitPackageResources instance;
        public Wrapper(IXframeHookInitPackageResources instance) {
